...
export class ConversationService {
      ...
      [
        {
          title: '⭐ Most Popular',
          rows: [
            { id: 'cat_AC', title: '❄️ AC Service', description: 'Repair, Install, Gas Fill' },
            { id: 'cat_CLEANING', title: '🧹 Cleaning', description: 'Deep Clean, Regular' },
            { id: 'cat_PLUMBING', title: '🔧 Plumbing', description: 'Leaks, Installation' }
          ]
        },
        {
          title: '🔥 In Demand',
          rows: [
            { id: 'cat_ELECTRICAL', title: '⚡ Electrical', description: 'Wiring, Fan, Switches' },
            { id: 'cat_PAINTING', title: '🎨 Painting', description: 'Interior, Exterior' },
            { id: 'cat_CARPENTER', title: '🪚 Carpentry', description: 'Furniture, Doors' }
          ]
        }
      ]
    );
  ...
  private async handleCategory(message: IncomingMessage, state: ConversationState): Promise<void> {
    const categoryId = message.buttonReply?.id?.replace('cat_', '') || 
                       message.listReply?.id?.replace('cat_', '') ||
    ...
    const categoryDetails = {
      ...
      'ELECTRICAL': { emoji: '⚡', name: 'Electrical', services: [
        { id: 'sub_WIRING', title: '🔌 Wiring', desc: 'New wiring, rewiring' },
        { id: 'sub_REPAIR', title: '🔧 Repair', desc: 'Switches, fans, lights' },
        { id: 'sub_INSTALL', title: '💡 Installation', desc: 'Lights, fans, appliances' }
      ]},
      'PAINTING': { emoji: '🎨', name: 'Painting', services: [
        { id: 'sub_INTERIOR', title: '🏠 Interior', desc: 'Walls, ceiling, rooms' },
        { id: 'sub_EXTERIOR', title: '🏗️ Exterior', desc: 'Building, balcony' },
        { id: 'sub_WATERPROOF', title: '💧 Waterproofing', desc: 'Leakage prevention' }
      ]},
      'CARPENTER': { emoji: '🪚', name: 'Carpentry', services: [
        { id: 'sub_FURNITURE', title: '🪑 Furniture', desc: 'Making, repair' },
        { id: 'sub_DOOR', title: '🚪 Door/Window', desc: 'Install, repair' },
        { id: 'sub_CABINET', title: '🗄️ Cabinet/Shelf', desc: 'Kitchen, wardrobe' }
      ]}
    };
